      ...
      <div className="flex  gap-8 w-full md:w-1/3 flex-col-reverse">
        ...
        <div className="flex flex-col gap-4">
          ...
          {/* <div className="flex gap-4 text-2xl">
            ...
            <Link
              target="_blank"
              href="https://www.tiktok.com/@iurisinternational"
            >
              <svg
                stroke="currentColor"
                fill="currentColor"
            ...
            <Link target="_blank" href="https://t.me/IURISINTERNATIONAL">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
            ...
            <Link
              target="_blank"
              href="https://discord.com/channels/@me/iurisinternational_09171/"
            >
              <svg
                stroke="currentColor"
                fill="currentColor"
            ...
            <Link
              target="_blank"
              href="https://www.youtube.com/@IURISINTERNATIONAL"
            >
              <svg
                stroke="currentColor"
                fill="currentColor"
            ...
            <Link target="_blank" href="https://wa.me/6285822476880">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
            ...
            <Link target="_blank" href="https://twitter.com/iurispt">
              <svg
                stroke="currentColor"
                fill="currentColor"
                strokeWidth="0"
